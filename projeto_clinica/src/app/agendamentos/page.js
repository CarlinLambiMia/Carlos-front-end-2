...
export default function consultas() {
    ...
    return (
        <div className={styles.container}>
            <h1 className={styles.h1}>Lista de Consutas</h1>
            <div className={styles.containerPesquisa}>
                ...
                <button onClick={() => { setShowListaDePesquisaPaciente(!showListaDePesquisaPaciente) }} className={styles.botaoPesquisarPaciente}>Pesquisar paciente</button>
                {
